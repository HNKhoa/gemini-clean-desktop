const WATERMARK_CONFIG_BY_TIER = Object.freeze({
    ...
    '2k-new-margin': Object.freeze({ logoSize: 96, marginRight: 192, marginBottom: 192, alphaVariant: '20260520' })
});
...
export function resolveOfficialGeminiSearchConfigs(
    ...
    const candidates = OFFICIAL_GEMINI_IMAGE_SIZES
        .map((entry) => {
            ...
            if (baseConfig.alphaVariant) config.alphaVariant = baseConfig.alphaVariant;
